...
public class MainFrame extends javax.swing.JFrame {
    ...
    private final String version = " by Murgu Andrei";
    ...
    public void initComponents() {
        ...
        logolabel.setText("K-Map Solver " + version);
    ...
    public void solveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_solveActionPerformed
        ...
        if (soln.isEmpty()) {
            ...
            Object[] optionsText = {"Maxtermen", "Mintermen"};

            int choice = JOptionPane.showOptionDialog(null,
                    "Maxtermen or Mintermen?", "Choose Output Type",
    ...
    private void logolabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_logolabelMouseClicked
        try {
            ...
            desktop.browse(new URI("https://github.com/AndreiMrg02/Proiect_Murgu_Andrei-Marian"));
